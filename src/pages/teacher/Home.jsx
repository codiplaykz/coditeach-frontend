		...
		<div className='flex flex-col h-screen pl-10 pt-5 overflow-y-hidden'>
			...
			<div className='flex basis-full mt-8'>
				<div className='flex flex-col basis-3/5 h-screen'>
					...
					<div className='flex flex-col w-full items-start py-6 px-4 border-2 border-gray-extra-light rounded-xl mt-6'>
						<h4 className='font-bold text-black text-base'>Классы <span className='text-primary'>4</span></h4>
						{
							Array(4).fill('0').map((index) => (
								<div className='flex w-full justify-between items-center pl-6 h-14 border-2 group border-gray-extra-light hover:border-primary rounded-xl cursor-pointer mt-3' key={index}>
									<h4 className='font-bold text-black text-base'>9B</h4>
									<span className='text-base'>Вводный урок</span>
									<span className='text-base'>24 уч. / 94%</span>
									<div className='flex items-center justify-center bg-gray-extra-light group-hover:bg-primary h-14 w-14 rounded-xl'>
										<FaStar className='text-black group-hover:text-white text-lg' />
									</div>
								</div>
							))
						}
				...
				<div className='flex flex-col basis-2/5 mx-8 p-8 bg-main-bg rounded-xl '>
